...
// Move getPos and generateSquares outside the component
...
function generateSquares(count: number, dimensions: { width: number; height: number }, width: number, height: number) {
...
export function AnimatedGridPattern(props: AnimatedGridPatternProps) {
  const {
    width = 40,
    height = 40,
    x = -1,
