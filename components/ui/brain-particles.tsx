...
export const BrainParticleMaterial = shaderMaterial(
  { time: 0, color: new THREE.Color(0.1, 0.3, 0.6) }, // reverted to original blueish color
  // vertex shader
  /*glsl*/ `
    varying vec2 vUv;
    uniform float time;
    ...
    <>
      <points>
        <bufferGeometry attach="geometry" ref={brainGeo}>
          {/* @ts-expect-error: react-three-fiber types do not match BufferAttribute signature, but this is safe */}
          <bufferAttribute
        ...
        {React.createElement('brainParticleMaterial', {
          attach: 'material',
          depthTest: false,
          depthWrite: false,
          transparent: true,
